<?php 
	...
	if($dt = mysql_fetch_array($q_paket)) {
			...
			<div class="da-panel">
				<div class="da-panel-header">
					<span class="da-panel-title">
						<i class="icon-edit"></i> Paket
					</span>
				</div>
				<div class="da-panel-content da-form-container">
					<form id="da-ex-validate1" enctype="multipart/form-data" class="da-form" method="post" action="functions/crud/crud_paket.php">
						<div id="da-ex-val1-error" class="da-message error" style="display:none;"></div>
						<div class="da-form-inline">
							<div class="da-form-row">
								<label class="da-form-label">Nama Paket<span class="required">*</span></label>
							...
							<div class="da-form-row">
								<label class="da-form-label">Keterangan<span class="required">*</span></label>
								<div class="da-form-item large">
									<textarea rows="auto" cols="auto" name="keterangan" class="span12"></textarea>	
								</div>
							</div>
							<div class="da-form-row">
